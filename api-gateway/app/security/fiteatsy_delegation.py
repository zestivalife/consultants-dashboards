...
def issue_fiteatsy_delegation(*, subject: str, permissions: list[str], purpose: str, actor_type: str, tenant_id: str | None = None) -> str:
    ...
    return jwt.encode(payload, settings.fiteatsy_delegation_private_key.replace("\\n", "\n"), algorithm="RS256", headers={"kid": settings.fiteatsy_delegation_key_id, "typ": "Zestiva-Delegated-Authority"})
