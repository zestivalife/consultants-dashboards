...
class Settings(BaseSettings):
    ...
    app_port: int = Field(default=8003, validation_alias=AliasChoices("PORT", "APP_PORT", "app_port"))
    ...
    trusted_hosts: str = (
        "*.railway.app,*.railway.internal,assessment-service,api-gateway,localhost,127.0.0.1"
    )
